...
class Client(object):
    ...
    def __init__(self, client_id=None, client_secret=None):
        if not client_id:
            ...
            client_id = 'PAR_jobirl_c6b32067711f97ca92e45e3990b56a49b217e647c3a765d857277655fa190083'
            if not client_id:
    ...
    def access_token(self, valid_for=datetime.timedelta(seconds=5)):
        ...
        auth_request = requests.post(
            ...
            data={
                ...
                'scope' : 'application_PAR_jobirl_c6b32067711f97ca92e45e3990b56a49b217e647c3a765d857277655fa190083 api_infotravailv1 api_offresdemploiv2 o2dsoffre api_romev1 nomenclatureRome',
